...
QtPlugin {
    ...
    frameworksDebug: ["AVFoundation", "CoreAudio", "AudioToolbox", "MobileCoreServices", "Foundation", "UIKit", "CoreFoundation", "Security", "SystemConfiguration", "CoreText", "CoreGraphics", "OpenGLES"]
    frameworksRelease: ["AVFoundation", "CoreAudio", "AudioToolbox", "MobileCoreServices", "Foundation", "UIKit", "CoreFoundation", "Security", "SystemConfiguration", "CoreText", "CoreGraphics", "OpenGLES"]
    frameworkPathsDebug: []
    frameworkPathsRelease: []
    libNameForLinkerDebug: "qtaudio_coreaudio_debug"
    libNameForLinkerRelease: "qtaudio_coreaudio"
    libFilePathDebug: "/Users/davidshrader/Qt/5.6/ios/plugins/audio/libqtaudio_coreaudio_debug.a"
    libFilePathRelease: "/Users/davidshrader/Qt/5.6/ios/plugins/audio/libqtaudio_coreaudio.a"
